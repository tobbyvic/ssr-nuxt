  ...
  <div class="min-h-full">
    ...
    <!-- 
      <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-3 px-2 sm:px-3 lg:px-8">
    ...
    <main class="mb-36">
      <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <Content :onIputSearch="onInputSearch" />
        <!-- /End replace -->
      </div>
    </main>

    <footer class="text-center bg-gray-900 text-white fixed bottom-0 w-full">
      ...
      <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2)">
        备案号:
        <a class="text-whitehite" href="https://beian.miit.gov.cn/"
          >豫ICP备2022001015号-1</a
        >
      </div>
    </footer>
  </div>
